...
public class PasswordHasher : IPasswordHasher
{
    ...
    public Users_HashedPassword Hash(string password)
    {
        ...
        return new Users_HashedPassword(hash, salt, hashAlgorithmSignature);
    }

    public bool Compare(string password, Users_HashedPassword hash)
    {
        var hashAlgorithmSignature =
            $"$argon2id$v={AlgorithmVersion}$m={MemorySize},t={NumberOfPasses},p={DegreeOfParallelism}";
